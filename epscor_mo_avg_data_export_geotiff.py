...
outfile = 'processed_data/' + gcm + '_' + var + '_' + str(startyr) + '-' + str(endyr) + '_raster.tif'

output_raster = gdal.GetDriverByName('GTiff').Create(outfile, ncols, nrows, nyrs, gdal.GDT_Float32)  # Open the file
